...
ActiveRecord::Schema.define(version: 2018_05_02_160752) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "author_comment_posts", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "comment_id"
    t.bigint "post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comment_id"], name: "index_author_comment_posts_on_comment_id"
    t.index ["post_id"], name: "index_author_comment_posts_on_post_id"
    t.index ["user_id"], name: "index_author_comment_posts_on_user_id"
  end
  ...
  add_foreign_key "author_comment_posts", "comments"
  add_foreign_key "author_comment_posts", "posts"
